...
def funcao_repeticao(n, m):
    ...
    for j in range(m):
        ...
        matplotlib.pyplot.scatter(soma1, soma2)
    ...
    return distancia_media, #matplotlib.pyplot.show()
...
job1 = job_server.submit(funcao_repeticao, (2, 4000),(funcao_pulo,), ("numpy", "math", "matplotlib.pyplot"))
job2 = job_server.submit(funcao_repeticao, (2, 4000),(funcao_pulo,), ("numpy", "math", "matplotlib.pyplot"))
